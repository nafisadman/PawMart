        ...
        <div className="hero">
          <div className="hero-content flex-col lg:flex-row gap-8 lg:gap-16">
            <img
              ...
              className="max-w-sm w-full rounded-box shadow-lg"
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="py-6 text-base lg:text-lg text-base-content/80">
                ...
                shelters. By adopting instead of buying, you’re not only welcoming
                a loyal companion into your home but also helping reduce unethical
